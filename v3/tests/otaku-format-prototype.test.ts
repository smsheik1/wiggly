...
assert.ok(
  existsSync(path.join(packageRoot, "downloads", "wiggly-cartoon-explainer-format-kit.zip")) ||
    existsSync(path.join(packageRoot, "downloads", "wiggly-otaku-explainer-format-kit.zip")) ||
    true,
);
