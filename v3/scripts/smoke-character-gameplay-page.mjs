...
const archive = "https://github.com/smsheik1/wiggly-character-gameplay-conversations/releases/download/v0.3.0/character-gameplay-conversations-0.3.0.zip";
const expectedHash = "0894effb3176d41c2710e4fd11e883d424771c8e9ebdefba8c355010efbb41e8";
...
try {
  ...
  const download = await page.request.get(archive);
