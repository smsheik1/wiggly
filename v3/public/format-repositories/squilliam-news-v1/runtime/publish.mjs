...
const USAGE = "Usage: node runtime/publish.mjs <inputs/distribution.json> [examples/we-the-artists/evidence/final.mp4] [--dry-run]";
...
async function main() {
  ...
  const mediaPath = positionalArgs[1] 
    ...
    : resolve(dirname(inputPath), "..", distConfig.media || "examples/we-the-artists/evidence/final.mp4");
