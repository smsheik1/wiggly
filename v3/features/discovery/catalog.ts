...
export const discoveryCatalog: DiscoveryEntry[] = [
  {
    ...
    curatorNote: "A 9:16 Shorts revision of the original blind-agent episode, using the same Arkham footage, six voice clips, script and timing. The maintainer updated the official layout at the user's request; detailed audiovisual review is unrecorded. The Repo takes supplied media—it does not download gameplay or generate voices.",
    goal: "entertain",
    media: {
      kind: "video",
      src: "/format-repositories/character-gameplay-conversations-v1/examples/batman-spongebob-shorts.mp4",
    ...
    format: { slug: "character-gameplay-conversations", name: "Character Gameplay Conversations", version: "0.1.3", owner: "Wiggly Studio" },
  },
  {
