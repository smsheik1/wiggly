...
export const discoveryCatalog: DiscoveryEntry[] = [
  ...
  },
  {
    ...
    status: "published",
    order: 16,
    brand: "Batman & Robin · Human Reality Q&A",
    title: "Robin Asked Bruce How He Sleeps",
    curatorNote: "Modeled from the #1 viral Arkham format (5.2M views). Robin asks Bruce how a normal human vigilante physically survives on zero sleep. Dual-speaker Conroy/Robin voices over Arkham Knight Gotham night gliding with Yeat ducked instrumental.",
    goal: "entertain",
    media: {
      kind: "video",
      src: "/format-repositories/character-gameplay-conversations-v1/examples/how-batman-sleeps.mp4",
      poster: "/format-repositories/character-gameplay-conversations-v1/examples/how-batman-sleeps-poster.jpg",
  ...
  },
  {
    ...
    status: "published",
    order: 17,
    brand: "Batman × Spider-Man · Multi-Universe Crossover",
    title: "Why Batman Counters Spider-Man",
    curatorNote: "High-spectacle multi-universe crossover (767K views). Dynamic gameplay switching between Batman Arkham Knight night gliding and Spider-Man 2 PS5 web-swinging, with digital scanline glitch cuts and whoosh SFX.",
    goal: "entertain",
    media: {
      kind: "video",
      src: "/format-repositories/character-gameplay-conversations-v1/examples/batman-vs-spiderman-crossover.mp4",
      poster: "/format-repositories/character-gameplay-conversations-v1/examples/batman-vs-spiderman-poster.jpg",
  ...
  },
  {
    ...
    status: "published",
    order: 18,
    brand: "Batman & Robin · Top 5 Countdown",
    title: "Top 5 Villains Batman Respects",
    curatorNote: "High-retention ranked countdown format (648K views). Left-side animated ranking ladder (#5 to #1) revealing docked villain cards (Mr. Freeze, Two-Face, Riddler, Bane, Ra's al Ghul) over continuous Arkham rooftop gliding.",
    goal: "entertain",
    media: {
      kind: "video",
      src: "/format-repositories/character-gameplay-conversations-v1/examples/top-5-batman-villains.mp4",
      poster: "/format-repositories/character-gameplay-conversations-v1/examples/top-5-batman-villains-poster.jpg",
      durationLabel: "59 sec",
      aspectRatio: "9:16",
    },
    format: { slug: "character-gameplay-conversations", name: "Batman Arkham Conversations", version: "0.2.0", owner: "Wiggly Studio" },
  ...
  {
    id: "roast-me-specular-commentary",
    status: "published",
    order: 99.1,
    brand: "SpecularAction Commentary · 9:16 Shorts",
    title: "Sonic Marketing & Fortnite Lore",
    curatorNote: "SpecularAction reaction commentary format. Dark Twitter/X post card with gold verified badge transitions into rapid conversational dialogue with animated 2D avatar swaying and reacting with facial emotion cues over continuous Minecraft parkour.",
    goal: "entertain",
    media: {
      kind: "video",
      src: "/format-repositories/roast-me-conversations-v1/examples/specular-commentary.mp4",
      poster: "/format-repositories/roast-me-conversations-v1/examples/specular-commentary-poster.jpg",
  ...
  {
    id: "roast-me-startup-pitch",
    status: "published",
    order: 99.2,
    brand: "Silicon Valley Roasts · 9:16 Shorts",
    title: "AI Startup Pitch Deck Roast",
    curatorNote: "Domain-transfer proof applying the roast format to tech startup comedy. Founder tweets pitch deck prompt, followed by brutal feedback from Marc and Alex with synced dialogue audio and iOS message pop SFX.",
    goal: "entertain",
    media: {
      kind: "video",
      src: "/format-repositories/roast-me-conversations-v1/examples/startup-pitch.mp4",
      poster: "/format-repositories/roast-me-conversations-v1/examples/startup-pitch-poster.jpg",
  ...
  {
    id: "roast-me-family-friends-avatar",
    status: "published",
    order: 99.3,
    brand: "Wiggly Format Repo · 9:16 Shorts",
    title: "Family & Friends Roast (With Avatar)",
    curatorNote: "The full 39-second viral family roast with the male character presenter in the foreground, reacting with shock, laughter, and commentary as roasts from Mom, Ben, and Dad arrive over Minecraft parkour.",
    goal: "entertain",
    media: {
      kind: "video",
      src: "/format-repositories/roast-me-conversations-v1/examples/family-friends-presenter.mp4",
      poster: "/format-repositories/roast-me-conversations-v1/examples/family-friends-presenter-poster.jpg",
      durationLabel: "39 sec",
      aspectRatio: "9:16",
    },
    format: { slug: "roast-me-conversations", name: "Roast Me Conversations", version: "0.2.0", owner: "Wiggly Studio" },
...
export const discoveryShelfDefinitions = [
  ...
  },
  {
    ...
    title: "Batman Arkham Conversations",
    description: "Viral character dialogue and multi-universe matchups over Arkham Knight and Spider-Man 2 gameplay.",
