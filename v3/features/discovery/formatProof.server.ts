...
const formatConfigs: FormatProfileConfig[] = [
  ...
  },
  {
    ...
    whatStays: [
      ...
      "Real browser and coding-agent actions inside macOS window chrome",
      "Retro grids, numbered badges, neon checkpoints, captions, and a progress rail",
      "One packaged Remotion compositor with inspection, hashes, and a zero-provider receipt",
    ],
    whatChanges: [
      "The source Wiggly Format and its audience",
      "The supplied browser/terminal captures, narration, and timed captions",
      "The format-specific proof, checkpoint copy, assets, and workflow steps",
    ...
    handoff: {
      ...
      deliverables: [
        ...
        "The signature grid/window/badge/checkpoint/caption compositor",
        "A local runner, ingredient contracts, provenance, and quality receipt",
  ...
  },
  {
    ...
    promise: "Turn breaking cultural trends into animated multi-shot commentary Shorts. The kit scouts live Reddit/curator scoops ($0), frames counterintuitive angles, writes causality-driven scripts, and directs animated Shaz and Chibi performances at 24 fps.",
    lastUpdated: "September 2026",
    ...
    handoff: {
      requiredInputs: [
        ...
        "Dialogue audio, or an agent-generated script following writer-playbook.md",
        "One built-in background (Sisters Room is default)",
        "Talk to Camera for ordinary speech, or multi-shot with Chibi commentary holds",
      ],
      deliverables: [
        ...
        "One 1280 × 720 multi-shot or talking-scene MP4",
      ...
      instructions: [
        "Download the Repo, report the version in KIT-MANIFEST.json, then run npm install, npm test, npm run check, and npm run smoke",
        ...
        "For multi-shot commentary, arrange talk-to-camera, text-card, chibi-commentary, and b-roll shots per director-playbook.md",
        "Run transcribe, init, validate, render, and inspect in order; Cherry supplies cues and the recovered Shaz rig remains the only renderer",
      ...
      output: "One 1280 × 720 animated Shaz commentary MP4, plus the checks and review record used to deliver it",
